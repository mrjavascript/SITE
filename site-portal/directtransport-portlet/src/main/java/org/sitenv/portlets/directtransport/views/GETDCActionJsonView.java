...
@Component("getdcActionJsonView")
public class GETDCActionJsonView extends AbstractView {

	private Logger logger = Logger.getLogger(GETDCActionJsonView.class);

	public GETDCActionJsonView() {
		super();
