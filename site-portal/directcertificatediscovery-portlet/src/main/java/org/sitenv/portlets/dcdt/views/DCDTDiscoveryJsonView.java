...
@Component("dcdtDiscoveryJsonView")
public class DCDTDiscoveryJsonView extends AbstractView {

	
private Logger logger = Logger.getLogger(DCDTDiscoveryJsonView.class);
	
	public DCDTDiscoveryJsonView() {
		super();
