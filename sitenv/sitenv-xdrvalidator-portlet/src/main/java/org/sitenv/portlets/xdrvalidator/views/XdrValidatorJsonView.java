...
@Component("xdrValidatorJsonView")
public class XdrValidatorJsonView extends AbstractView {
	
	private Logger logger = Logger.getLogger(XdrValidatorJsonView.class);
	
	public XdrValidatorJsonView() {
		super();
