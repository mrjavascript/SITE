...
import sit.portal.directtransport.services.model.jsTreeNode;

public class GetCCDASamplesTree extends HttpServlet{

	private static final long serialVersionUID = 1L;
	
	public static final String SAMPLECCDAROOT = "SampleCCDA";
	
	private static Logger _log = Logger.getLogger(GetCCDASamplesTree.class);
