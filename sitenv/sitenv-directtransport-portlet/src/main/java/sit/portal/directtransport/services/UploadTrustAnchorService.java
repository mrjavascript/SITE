...
import sit.portal.directtransport.services.model.GenericResult;

public class UploadTrustAnchorService extends HttpServlet{
	
	private static final long serialVersionUID = 1L;
	
	private static Logger _log = Logger.getLogger(UploadTrustAnchorService.class);
